<?php
	...
	if(!isset ($_GET["edit"])){
			...
			if(isset($_GET["product"]) && isset($_GET["group"])&& isset($_GET["price"])){
				...
				$stmt->bind_param("sssi", $_GET["product"], $_GET["group"], $_GET["price"],$_GET["edit"]);
...
<form method="get">
	...
	<input type="text" name="product" value="<?=$start_location; ?>" <br><br>
	
	
	<label for="group">Group:<label><br>
	<input type="text" name="group" value="<?=$destination; ?>" <br><br>
